      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12 reveal">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-primary-600 dark:text-primary-400 mb-1">Vice Chair</h3>
              <h4 className="text-lg font-medium text-gray-900 dark:text-white mb-1">{executiveCommittee.viceChair.name}</h4>
              <p className="text-gray-600 dark:text-gray-300">{executiveCommittee.viceChair.title}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 reveal">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
            ...
            <h4 className="text-base font-medium text-gray-900 dark:text-white mb-1">{executiveCommittee.technicalChair.name}</h4>
            <p className="text-sm text-gray-600 dark:text-gray-300">{executiveCommittee.technicalChair.title}</p>
          </div>

          {/* Funding Chair */}
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-md">
            <h3 className="text-lg font-semibold text-primary-600 dark:text-primary-400 mb-2">Funding Chair</h3>
            <h4 className="text-base font-medium text-gray-900 dark:text-white mb-1">{executiveCommittee.fundingChair.name}</h4>
            <p className="text-sm text-gray-600 dark:text-gray-300">{executiveCommittee.fundingChair.title}</p>
          </div>
